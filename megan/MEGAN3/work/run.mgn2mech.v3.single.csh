...
setenv EFMAPS  $INPDIR/EFMAPS3.$GDNAM3D.$scen.single.nc

# MEGAN ER filename
setenv MGNERS $INTDIR/MGNERS.$GDNAM3D.$scen.${SDATE}.single.baseline.nc

# MEGSEA filename
setenv MGNSEA $INTDIR/MGNSEA.$GDNAM3D.${SDATE}.single.baseline.nc

# Output filename
setenv MGNOUT $OUTDIR/MEGANv3.$GDNAM3D.$scen.$MECHANISM.$SDATE.single.nc
