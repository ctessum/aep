...
func TestMegseaAgainstStandalone(t *testing.T) {
	//t.Logf("MEGAN_STANDALONE_TEST=%v",os.Getenv("MEGAN_STANDALONE_TEST"))
...
func run_go_megsea() Megsea_output {
	...
	return SoilMoistureAndNOEmissionActivityFactors(2013145, 0, 10000, 25, true, temperature, soil_moisture, soil_temperature, precip_adjustment, lai, lattitude, soil_type, canopy_type_factor)
}
